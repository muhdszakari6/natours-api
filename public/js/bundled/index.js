...
})({"AvRjX":[function(require,module,exports) {
"use strict";
...
/* eslint-disable */ var require1 = window.require;
...
},{}],"kxdiQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const displayMap = (locations)=>{
    mapboxgl.accessToken = "pk.eyJ1Ijoic2FsaW16YWthcmkiLCJhIjoiY2w0MThodms5MGRzNDNlbnZ5OTJmZjZjMyJ9.evbFI31AJIVa51M_6f4DgQ";
    const map = new mapboxgl.Map({
        container: "map",
        style: "mapbox://styles/salimzakari/cl41ay1n7001714n0sx7ftup1",
    ...
    locations.forEach((loc)=>{
        ...
        new mapboxgl.Popup({
            offset: 30
        }).setLngLat(loc.coordinates).setHTML(`
...
const bookTour = async (tourId)=>{
    const stripe = Stripe("pk_test_51LALqfBjweXZCTdyRp7LLriP1BB82eaiqPT1k30L5gK8pzpt5cL6PQMlHabrcEpMs4GVzeeU51TiM8EcasoDguBF00TrwnymJU");
    try {
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./alert":"kxdiQ"}]},["AvRjX","f2QDv"], "f2QDv", "parcelRequire11c7")
